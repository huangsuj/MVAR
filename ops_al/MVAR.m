function [W,b,F,ypre, Fu] = MVAR(Xl,Xu,Yl,lambda, s, r,maxIter)
...
%     save('C:\Users\hsj\OneDrive\my_paper\HGCNNet_for_hsj\results\scatter\BBCSports\MVAR_representation.mat', 'Fu')
    [~,ypre] = max(Fu,[],2);
